...
public class MusicServiceTests {
    private Object[][] model = new Object[][]{
        ...
        {"Threadbare Loaf", "What Happened To Out First CD?", 17},
    ...
    void testSongVoting(MusicService service) {
        ...
        iterateOverModel(data ->
            assertEquals(
                    service.getSong((String) data[0], (String) data[1])
                            .getVotes(), ((Integer) data[2]).intValue()
            ));
    }
    ...
    void testSongsForArtist(MusicService service) {
        ...
        assertEquals(songs.get(0).getName(), "What Happened To Out First CD?");
    ...
    void testMatchingSongNamesForArtist(MusicService service) {
        ...
        assertEquals(names.get(0), "What Happened To Out First CD?");
    }
}
